...
CONFIG_MSG_FORMAT = OrderedDict([
    ('node_id',np.dtype(np.uint32)),
    ('scan_start',np.dtype(np.int32)),
    ('scan_stop',np.dtype(np.int32)),
    ('scan_res',np.dtype(np.uint16)),
    ('pii',np.dtype(np.uint16)),
    ('seg_1_samp',np.dtype(np.uint16)),
    ('seg_2_samp',np.dtype(np.uint16)),
    ('seg_3_samp',np.dtype(np.uint16)),
    ('seg_4_samp',np.dtype(np.uint16)),
    ('seg_1_int',np.dtype(np.uint8)),
    ('seg_2_int',np.dtype(np.uint8)),
    ('seg_3_int',np.dtype(np.uint8)),
    ('seg_4_int',np.dtype(np.uint8)),
    ('ant_mode',np.dtype(np.uint8)),
